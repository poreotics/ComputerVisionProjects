...
figure(8); imshow(imfilter(test_image,identity_filter));
...
figure(9); imshow(imfilter(test_image, blur_filter));
...
figure(10); imshow(imfilter(large_blur_image,large_1d_blur_filter'));
...
figure(11); imshow(imfilter(test_image,sobel_filter)+0.5);
...
figure(12); imshow(imfilter(test_image,laplacian_filter)+0.5);
