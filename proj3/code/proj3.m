...
data_path = '/course/cs143/asgn/proj3/data/'; %change if you want to work with a network copy
...
switch lower(FEATURE)    
    ...
    case 'spatial_matching'
        ...
        train_image_feats = spatial_matching(train_image_paths);
        test_image_feats  = spatial_matching(test_image_paths);
